...
<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<h2>Редактирование записи - {{$project->name}}</h2>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
							...
							<form class="right" action="{{route('admin.adminpanel.project.update')}}" method="post">
                                  @csrf
                                   @method('PUT')
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<input class="text-input small-input" type="text" name="title" value="{{$project->name}}" />
									...
									<p><input class="text-input small-input" type="text" name="images" id="images"   value="{{$project->images}}" /> <span class="input-notification information">Картинка (<a href="#" class="dialog_link" id="upload">Загрузить</a>)</span></p>
								<p><div id="files"></div><div id="status"></div></p>
								<p ><div id="current_image"><img src="{{asset('storage/help/'.$project->image)}}"></div><div id="status"></div></p>
								<textarea class="ckeditor" cols="80" id="editor1" name="editor1" rows="10"><p>{!!$project->text!!}</p></textarea>
