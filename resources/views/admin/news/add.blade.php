						...
						<form action="/admin/news/store" method="post">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
                                    ...
                                    <br />
                                    <input class="text-input small-input" type="text" name="mtitle" value=""  placeholder="Meta title"/>
                                    <span class="input-notification information">Meta title</span>
                                    <input class="text-input small-input" type="text" name="description" value="" placeholder="Meta description"/>
                                    <span class="input-notification information">Meta description</span>
                                    <input class="text-input small-input" type="text" name="keywords" value="" placeholder="Meta keywords"/>
