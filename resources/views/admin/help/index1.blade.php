  ...
  <div id="main-content"> <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3>Взаимопомощи &nbsp;&nbsp;( Хочу помочь )</h3>
							...
							<tbody>
							  ...
							  @foreach($helps as $help)
								<tr>
									...
									<td>{{$help->id}}</td>
									<td><a href="/admin/hochu_pom/edit/{{$help->id}}">{{$help->title}}</a></td>
									<td>{{$help->phone}}</td>
									...
									<td class="vzaimo_del" style="vertical-align: middle;">
										<!-- Icons -->
										  <a href="/admin/hocu_pom/delete/{{$help->id}}"  onclick="myFunction()" title="Удалить"><img src="{{asset('asset/admin/resources/images/icons/cross.png')}}" alt="Delete" /></a>
									</td>
								</tr>
							  @endforeach
							</tbody>
