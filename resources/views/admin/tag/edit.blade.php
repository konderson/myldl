...
<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<h2>Редактирование тег</h2>
			
			<div class="content-box"><!-- Start Content Box -->
				
				<div class="content-box-content">
			   
							<form class="right" action="{{route('admin.adminpanel.tag.update')}}" method="post">
                                  @csrf
                                   @method('PUT')
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p><input class="text-input small-input" type="text" name="nazva" value="{{$tag->name}}" /> <span class="input-notification information">Название тега</span> <!-- Classes for input-notification: success, error, information, attention --></p>
