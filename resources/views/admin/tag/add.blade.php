				...
				<div class="content-box-content">
						...
						<form action="/admin/tag/store/" method="post">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p><input class="text-input small-input" type="text" name="nazva" /> <span class="input-notification information">Название тега</span> <!-- Classes for input-notification: success, error, information, attention --></p>
