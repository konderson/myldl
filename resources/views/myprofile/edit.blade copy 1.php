...
@include('myprofile.left')
       <form class="right" action="https://myldl.ru/profile/save_profile" method="post">
            ...
            <div class="field-for-edit">
                ...
                <input type="text" id="pOrgName" name="name" placeholder="Имя / Название организации..." value="malicev" />
	                        </div>
            ...
            <div class='field-for-edit'>
                ...
                <input type="text" id="birthday" name="birthday" placeholder="Дата рождения" maxlength="10" value="" />
	                        </div>
            ...
            <div class='field-for-edit'>
                <div class="custom-select">
                    ...
                    <input type="text" placeholder="E-mail..." id="pMail" name="email" value="kondersonn@gmail.com" />
                </div>
            ...
            <div class="field-for-edit">
                ...
                <textarea placeholder="Увлечения..." id="pUvlecheniya" name="uvlecheniya"></textarea>
            </div>

            <div class="field-for-edit">
                <div class="mediaform" style="overflow: hidden;margin-bottom: 10px;clear: left;">
                    <button class="upload-photo" id="upload" style="width: auto; padding-left: 40px;"><img src="/static/images/photo-camera.png"/>Добавить фото</button>
                                        <span id="status"></span>
