...
@section('content')
    ...
    <ol class="breadcrumb">
        <li><a href="/">Главная</a></li><li style="color:#8e8e8e;">Ищу человека</li>    </ol>
</div>
...
var param=params['serch_by_name'];
   ...
   success:function(msg)
   {
        ...
        window.location.href = "naxodki?"+msg;
    }
    else{
        window.location.href = "search/naxodki?"+msg+"&serch_by_name="+param+"&type=3";
    }
...
<script>
    $(function(){
...

        {
            ...
            url:"/search/naxodki?country_id="+country_id+"&type=3" ,
            ...
            window.history.pushState({}, document.title, "/" + "naxodki");
    ...
    $.ajax(

        {
            ...
            url:"/search/naxodki?country_id="+country_id+"&type=3"+"&region_id="+region,
    ...
    $.ajax(

        {
            ...
            url:"/search/naxodki?country_id="+country_id+"&type=3"+"&region_id="+region+"&city_id="+sity,
         ...
         $(document).on('submit', '.search', function (e) {
            e.preventDefault();
            window.location.href = "/search/naxodki?serch_by_name=" + $('.ufilter').val()+"&type=3";
        });
    });
</script>
...
<section>
    <div class="advert">
        <div class="left">
            <div class="title">
                <h1 class="title">
Поиск пропавших без вести людей</h1>
