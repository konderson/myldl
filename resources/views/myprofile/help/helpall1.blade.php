...
@section('content')
    ...
    <ol class="breadcrumb">
        <li><a href="/">Главная</a></li><li style="color:#8e8e8e;">Хочу помочь</li>    </ol>
</div>
...
var param=params['serch_by_name'];
   ...
   success:function(msg)
   {
        ...
        window.location.href = "search/hochu_pom?"+msg+"&serch_by_name="+param+"&type=1";
    }
...
<script>
    $(function(){
...

        {
            ...
            url:"/search/hochu_pom?country_id="+country_id+"&type=1" ,
    ...
    $.ajax(

        {
            ...
            url:"/search/hochu_pom?country_id="+country_id+"&type=1"+"&region_id="+region,
    ...
    $.ajax(

        {
            ...
            url:"/search/hochu_pom?country_id="+country_id+"&type=1"+"&region_id="+region+"&city_id="+sity,
         ...
         $(document).on('submit', '.search', function (e) {
            e.preventDefault();
            window.location.href = "/search/hochu_pom?serch_by_name=" + $('.ufilter').val()+"&type=1";
        });
    });
</script>
