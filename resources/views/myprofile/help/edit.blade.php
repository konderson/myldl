...
<style>
    ...
    .error {
       ...
       <section>
        ...
        <form class="right" action="/profile/update/{{$help->id}}" method="POST">
            {{ csrf_field() }}
             @method('PUT')
            ...
            <div class="field-for-edit">
                ...
                <input type="text" placeholder="Заголовок..." name="title" id="hTheme" value="{{$help->title}}"/>
            ...
            <div class='field-for-edit'>
                ...
                <div class="custom-select">
                    ...
                    <input type="text" placeholder="Телефон..." name="phone" value="{{$help->phone}}"/>
                    <span class="error"></span>
                </div>

                <div class="custom-select">
                    <span class="edit-label">Соц. сети</span>
                    <input type="text" placeholder="Соц. сети..." name="cocial" value="{{$help->cocial}}"/>
                    <span class="error"></span>
                </div>
            </div>
            ...
            <div class="field-for-edit">
                ...
                <ul class="thumb-photos mclearfix remdiv" id="myDiv">
                    <li    style="list-style: none;"id="img_1"><figure><img class="thumb" src="{{asset('storage/help/'.$help->images)}}" alt="{{$help->title}}" title="{{$help->title}}" /></figure><a class="close" ><img src="{{asset('asset/front/images/close.png')}}" alt=""></a></li>                </ul>
