...
@include('myprofile.left')
     ...
     <form class="right" action="/profile/idea/store" method="post" id="add_idea_true">
            @csrf
           
            <div class="field-for-edit">
                <span class="edit-label">Тема</span>
                <input type="text" class="tfi" id="title" name="title"/>
            </div>

            <div class="field-for-edit">
                <span class="edit-label">Содержание</span>
                <textarea class="ckeditor" cols="80" id="editor2" name="content"></textarea>
            </div>
